...
namespace MovieLink.Data.MsSql
{
    ...
    {
        static readonly ILog Logger = LogManager.GetLogger(typeof(SqlHelper));

        private static readonly string ConnKey = "MovieConn"; 
        ...
        public static string GetConnSting()
        {
            ...
            try
            {
                connStr = ConfigurationManager.ConnectionStrings[ConnKey].ConnectionString; 
            }
            catch (Exception ex)
            {
                Logger.Error("SqlHelper.GetConnSting()发生错误："+ex.Message + ex.StackTrace);
            }
            return connStr;
        } 
        /// <summary> 
        ...
        { 
            ...
            {
                Logger.Error("SqlHelper.GetConnection()发生错误：" + ex.Message + ex.StackTrace);
            }
            return connection; 
        } 
        #endregion
